...
import { RESTClient } from './api/index';
...
class API {
    ...
    async request(
        ...
        this.client = new RESTClient({
            accessKey: (this.auth)?this.auth.credentials.AccessKeyId:'',
            secretKey: (this.auth)?this.auth.credentials.SecretKey:'',
            sessionToken: (this.auth)?this.auth.credentials.SessionToken:'',
        ...
        try {
            const req = { verb: method, path: '/auth' };
