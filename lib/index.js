...
import { apigClientFactory } from './api/apigClient';
...
export class API {
    ...
    async initApi() {
        var apigClient = apigClientFactory.newClient({
            accessKey: this.auth.credentials.AccessKeyId,
            secretKey: this.auth.credentials.SecretKey,
            sessionToken: this.auth.credentials.SessionToken, //OPTIONAL: If you are using temporary credentials you must include the session token
            region: Exports.AppStack.region // OPTIONAL: The region where the API is deployed, by default this parameter is set to us-east-1
        });
        /*
