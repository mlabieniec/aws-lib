...
class HttpClient {
    constructor(config) {
        Util.assertDefined(config.accessKey, 'accessKey');
        Util.assertDefined(config.secretKey, 'secretKey');
        config.sessionToken;
        Util.assertDefined(config.serviceName, 'serviceName');
        Util.assertDefined(config.region, 'region');
        Util.assertDefined(config.endpoint, 'endpoint');
